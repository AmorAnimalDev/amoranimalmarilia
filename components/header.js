(function(){
  ...
  s.insertAdjacentHTML('afterend',
    ...
    '      <li><a href="' + ROOT + '/index.html"><i class="bi bi-house-door"></i> In&iacute;cio</a></li>' +
    '      <li><a href="' + ROOT + '/pages/adocao.html"><i class="bi bi-paw"></i> Ado&ccedil;&atilde;o</a></li>' +
    '      <li><a href="' + ROOT + '/pages/castracao.html"><i class="bi bi-person-heart"></i> Castra&ccedil;&atilde;o</a></li>' +
    '      <li><a href="' + ROOT + '/pages/castracao_mutirao.html"><i class="bi bi-people"></i> Mutir&atilde;o</a></li>' +
    '      <li><a href="' + ROOT + '/pages/procura_se.html"><i class="bi bi-search"></i> Procura-se</a></li>' +
    '      <li><a href="' + ROOT + '/pages/doacao.html"><i class="bi bi-gift"></i> Doa&ccedil;&atilde;o</a></li>' +
    '      <li><a href="' + ROOT + '/pages/voluntario.html"><i class="bi bi-people-fill"></i> Volunt&aacute;rio</a></li>' +
    ...
    '      <li><a href="' + ROOT + '/pages/transparencia.html"><i class="bi bi-file-text"></i> Transpar&ecirc;ncia</a></li>' +
  ...
  /* --- Search Logic --- */
  var PAGES = [
    { t:"In&iacute;cio", d:"P&aacute;gina inicial da ONG Amor Animal", k:"inicio home principal ong amor animal marilia site entrada", i:"bi bi-house-door", c:"#14b8a6", u:"index.html" },
    { t:"Ado&ccedil;&atilde;o", d:"Animais dispon&iacute;veis para ado&ccedil;&atilde;o respons&aacute;vel", k:"adocao adotar adote adocao-responsavel pet cachorro gato cao caes felino filhote lar familia quero-adotar", i:"bi bi-paw", c:"#f59e0b", u:"pages/adocao.html" },
    { t:"Castra&ccedil;&atilde;o", d:"Central de agendamento de castra&ccedil;&atilde;o", k:"castracao castrar castracao-central cirurgia veterinario veterinaria animal animais esterilizar", i:"bi bi-person-heart", c:"#10b981", u:"pages/castracao.html" },
    { t:"Castra&ccedil;&atilde;o Baixo Custo", d:"Castra&ccedil;&atilde;o com valor social reduzido", k:"castracao castrar baixo-custo valor-social barato economico precos preco cirurgia veterinario castracao-preco", i:"bi bi-cash", c:"#059669", u:"pages/castracao_baixo_custo.html" },
    { t:"Mutir&atilde;o de Castra&ccedil;&atilde;o", d:"Mutir&otilde;es gratuitos de castra&ccedil;&atilde;o", k:"castracao mutirao mutirao-castracao gratuito gratis castracao-gratuita evento castrar cirurgia coletivo inscricao", i:"bi bi-people", c:"#047857", u:"pages/castracao_mutirao.html" },
    { t:"Inscri&ccedil;&atilde;o Mutir&atilde;o", d:"Formul&aacute;rio de inscri&ccedil;&atilde;o para mutir&atilde;o de castra&ccedil;&atilde;o", k:"castracao mutirao inscricao inscrever formulario cadastro vagas castracao-gratuita", i:"bi bi-pencil-square", c:"#065f46", u:"pages/castracao_mutirao_form.html" },
    { t:"Pets de Rua", d:"Castra&ccedil;&atilde;o para animais de rua", k:"castracao pets-rua rua animal-anonimo comunidade cuidado veterinario", i:"bi bi-heart", c:"#dc2626", u:"pages/castracao_pets_rua.html" },
    { t:"Castra&ccedil;&atilde;o Sucesso", d:"Confirma&ccedil;&atilde;o de inscri&ccedil;&atilde;o de castra&ccedil;&atilde;o", k:"castracao sucesso confirmacao inscricao realizada comprovante ticket protocolo", i:"bi bi-check-circle", c:"#16a34a", u:"pages/castracao_sucesso.html" },
    { t:"Procura-se", d:"Animais desaparecidos divulga&ccedil;&atilde;o", k:"procura-se perdido desaparecido busca sumido cachorro gato cao animal localizar encontrar", i:"bi bi-search", c:"#f97316", u:"pages/procura_se.html" },
    ...
    { t:"Doa&ccedil;&atilde;o", d:"Contribua com doa&ccedil;&otilde;es via PIX ou cart&atilde;o", k:"doacao doar contribuir pix dinheiro ajuda financeira doe contribuicao cartao credito debito ajuda", i:"bi bi-gift", c:"#8b5cf6", u:"pages/doacao.html" },
    ...
    { t:"Volunt&aacute;rio", d:"Cadastro de volunt&aacute;rios para ajudar a ONG", k:"voluntario voluntariado ajudar trabalho voluntario contribuir tempo doar", i:"bi bi-people-fill", c:"#ec4899", u:"pages/voluntario.html" },
    { t:"Sobre", d:"Conhe&ccedil;a a hist&oacute;ria e miss&atilde;o da ONG", k:"sobre nos historia missao quem-somos equipe fundacao resgate animais", i:"bi bi-info-circle", c:"#3b82f6", u:"pages/sobre.html" },
    { t:"Transpar&ecirc;ncia", d:"Presta&ccedil;&atilde;o de contas e documentos oficiais", k:"transparencia prestacao-contas contas documentos relatorio financeiro receitas despesas", i:"bi bi-file-text", c:"#6366f1", u:"pages/transparencia.html" },
    { t:"Eventos", d:"Eventos feiras e mutir&otilde;es da ONG", k:"eventos feira adocao mutirao castracao agenda calendario bazar beneficente", i:"bi bi-calendar-event", c:"#a855f7", u:"pages/eventos.html" },
    { t:"Pol&iacute;tica de Privacidade", d:"Termos e pol&iacute;tica de privacidade do site", k:"politica privacidade termos dados LGPD protecao informacao", i:"bi bi-shield-lock", c:"#6b7280", u:"pages/policy.html" },
  ...
  var API_SECTIONS = [
    { t:"Eventos na Landing", d:"Eventos cadastrados na p&aacute;gina inicial", k:"evento agenda calendario programacao", i:"bi bi-calendar-event", c:"#a855f7", e:"eventos", f:"titulo" },
    { t:"Castracoes", d:"Agendamentos de castra&ccedil;&atilde;o realizados", k:"castracao cirurgia castrar agendamento veterinario", i:"bi bi-person-heart", c:"#10b981", e:"castracao", f:"nome_pet" },
    { t:"Pets para Ado&ccedil;&atilde;o", d:"Animais dispon&iacute;veis para ado&ccedil;&atilde;o", k:"pet cachorro gato cao felino adocao animal", i:"bi bi-paw", c:"#f59e0b", e:"adocao", f:"nome" },
    { t:"Volunt&aacute;rios", d:"Volunt&aacute;rios cadastrados no sistema", k:"voluntario voluntariado ajuda contribuir", i:"bi bi-people-fill", c:"#ec4899", e:"voluntario", f:"nome" },
    ...
    { t:"Animais Perdidos", d:"Animais desaparecidos divulga&ccedil;&atilde;o", k:"procura-se perdido desaparecido sumido busca", i:"bi bi-search", c:"#f97316", e:"procura_se", f:"nome" }
  ];
